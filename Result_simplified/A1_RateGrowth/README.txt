...
-Play around with runtime in block 6 to make sure you are capturing yield peaking in the graph below; larger complexes need more time to reach high yield as there will be more plateu stages.
...
- for higher mers the yield is not going to be high; yield at 1 sec (sim_runtime=1) is not close to 100% for larger mers.
